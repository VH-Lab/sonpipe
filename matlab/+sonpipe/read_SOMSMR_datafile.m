...
%       sonpipe.read_SOMSMR_datafile(FILENAME, HEADER, CHANNEL_NUMBER, T0, T1)
%
...
%
%   See also sonpipe.read_SOMSMR_header, sonpipe.read_SOMSMR_sampleinterval
	...
	ci = sonpipe.channelinfo(header, channel_number);
	kind = ci.kind;
